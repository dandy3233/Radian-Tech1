...
<div className="flex items-center space-x-3 ml-4">
  {[
    ...
    >
      ...
      {/* Main Header */}
      <header className={`bg-white/95 backdrop-blur-md sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'shadow-lg shadow-primary/5' : 'shadow-sm'}`}>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative" onMouseEnter={() => setServicesDropdown(true)} onMouseLeave={() => setServicesDropdown(false)}>
                <div className="flex items-center space-x-1 cursor-pointer">
                  <span className="hover:text-primary font-medium">Services</span>
                  <ChevronDown className="h-4 w-4" />
                </div>
                {servicesDropdown && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-md rounded-lg py-2 z-50">
                    <Link to="/services/ai-intelligence" className="block px-4 py-2 text-sm hover:text-primary">AI Intelligence</Link>
                    <Link to="/services/cloud-mastery" className="block px-4 py-2 text-sm hover:text-primary">Cloud Mastery</Link>
                    <Link to="/services/digital-innovation" className="block px-4 py-2 text-sm hover:text-primary">Digital Innovation</Link>
                    <Link to="/services/cyber-defense" className="block px-4 py-2 text-sm hover:text-primary">Cyber Defense</Link>
                  </div>
                )}
              </div>
              ...
              <div className="relative" onMouseEnter={() => setProductsDropdown(true)} onMouseLeave={() => setProductsDropdown(false)}>
                <div className="flex items-center space-x-1 cursor-pointer">
                  <span className="hover:text-primary font-medium">Products</span>
                  <ChevronDown className="h-4 w-4" />
                </div>
                {productsDropdown && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-md rounded-lg py-2 z-50">
                    <Link to="/products/product-a" className="block px-4 py-2 text-sm hover:text-primary">Product A</Link>
                    <Link to="/products/product-b" className="block px-4 py-2 text-sm hover:text-primary">Product B</Link>
                    <Link to="/products/product-c" className="block px-4 py-2 text-sm hover:text-primary">Product C</Link>
                  </div>
                )}
              </div>
...
>
  ...
  <span className="hover:text-red-500 transition-colors duration-300">09-27-44-61-71</span>
  <span
  ...
  ></span>
          ...
          {isMenuOpen && (
            <div className="md:hidden border-t border-border py-4 space-y-4">
              <Link to="/" className="block hover:text-primary" onClick={() => setIsMenuOpen(false)}>Home</Link>

              <div>
                <div className="font-medium">Services</div>
                <div className="ml-4">
                  <Link to="/services/ai-intelligence" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>AI Intelligence</Link>
                  <Link to="/services/cloud-mastery" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Cloud Mastery</Link>
                  <Link to="/services/digital-innovation" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Digital Innovation</Link>
                  <Link to="/services/cyber-defense" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Cyber Defense</Link>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="ml-4">
                  <Link to="/products/product-a" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Product A</Link>
                  <Link to="/products/product-b" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Product B</Link>
                  <Link to="/products/product-c" className="block text-sm hover:text-primary" onClick={() => setIsMenuOpen(false)}>Product C</Link>
                </div>
              </div>

              <Link to="/about" className="block hover:text-primary" onClick={() => setIsMenuOpen(false)}>About Us</Link>
